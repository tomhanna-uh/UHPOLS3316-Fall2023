...
**Please edit the part of the author: information above that is inside the quotation marks to reflect your name. Do not change anything else in the area marked by the --- on top and bottom. **

**This bonus problem set is worth 20% of a normal problem set**

**You can complete these any way you like, but be sure you complete the type of statistic asked for and consider what will help you most in practicing for the midterm. Since you will not have R available for the midterm, you may not want to use R.**
